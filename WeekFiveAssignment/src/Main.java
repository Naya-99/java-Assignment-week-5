...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Creating a list of farmers
		
		
		/*
		 * for(int i=0;i<10;i++) { farmersList.add(new Farmer()); }
		 * 
		 * for(int i=0;i<10;i++) { Farmer temp = farmersList.get(i); temp.setName();
		 * temp.setAge(); temp.setState(); temp.setPhone();
		 * 
		 * farmersList.set(i, temp); }
		 * 
		 * writeIntoFile();
		 */
		readFromFile();
